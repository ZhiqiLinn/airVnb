        ...
        <div className="booking-layout">
            <div>
                    ...
                    <div className="bookings-container">
                        <div className="notrip-card">
                            <div className="notrip-left">
                                ...
                                <p>
                                    Time to dust off your bags and start getting
                      ...
                      <div className="notrip-card">
                          <div className="notrip-left">
                              ...
                              <h3 style={{ fontWeight: "bold" }}>
                                ...
                                <p>{DateFormat(onGoingBookings[0].checkIn, onGoingBookings[0].checkOut)}</p>
                                <p>{`Hosted by ${findHostName(
                                    onGoingBookings[0].Listing.userId
                                )}`}</p>
                ...
                <div>
                    ...
                    <a
                        style={{ color: "black" }}
                        href="mailto:zhiqilinn@gmail.com"
                    >
